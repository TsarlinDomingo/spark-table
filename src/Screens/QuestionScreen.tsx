...
export default function QuestionScreen({ route, navigation }: QuestionScreenProps) {
  ...
  const onPress = () => navigation.navigate('Question', { questionId: getAnotherId(question.id, questions.length) });
  return (
    <View className="flex-1 flex-direction flex-col items-center justify-center bg-blue-500 h-full space-y-8 px-6">
      ...
      <TouchableOpacity className="rounded-3xl bg-green-500 px-10 py-4 h-fit" onPress={onPress}>
